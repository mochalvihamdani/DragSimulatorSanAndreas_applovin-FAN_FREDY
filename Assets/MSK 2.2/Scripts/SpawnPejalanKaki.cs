...
public class SpawnPejalanKaki : MonoBehaviour {
    public GameObject[] gameobject;
    public Transform TempatSpawnWalker;
    ...
    void Spawn(){
        ...
        objectkeeper = Instantiate (gameobject [number], TempatSpawnWalker.position, Quaternion.identity) as GameObject;
