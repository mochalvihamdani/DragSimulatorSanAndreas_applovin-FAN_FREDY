...
public enum ControlModeOnline { simple = 1, touch = 2 }

public class BikeControlOnline :  MonoBehaviourPunCallbacks, Photon.Pun.IPunObservable
{
public static BikeControlOnline Instance;
 [Tooltip("The Player's UI GameObject Prefab")]
        [SerializeField]
         public GameObject[] cameraGanti;
        public TextMeshPro playerNameText;
        //public GameObject playerUiPrefab;
    public ControlModeOnline controlMode= ControlModeOnline.simple;
   ...
   public static GameObject LocalPlayerInstance;
    ...
    public BikeSettingOnline bikeSetting;

    [System.Serializable]
    public class BikeSettingOnline
    {
...
if (photonView.IsMine)
  ...
  speed = myRigidbody.velocity.magnitude * 2.7f;
        ...
        if (activeControl)
        {
            ...
            if (controlMode == ControlModeOnline.simple)
            {
            ...
            else if (controlMode == ControlModeOnline.touch)
            {
